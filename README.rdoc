...
This application downloads corporate ownership data from the SEC's Edgar web app and processes it into a summary. I believe it is the most complete corporate ownership database available for free.
...
1. Install redis, any version should work, author used 2.8.13: http://redis.io/download
2. Install mysql. Any version should work, author used 5.5: https://dev.mysql.com/downloads/mysql/
3. Install mongodb, author used 3.0.8: https://www.mongodb.org/downloads#production
